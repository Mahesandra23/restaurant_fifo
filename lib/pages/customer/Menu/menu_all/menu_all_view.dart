...
import 'package:restaurant_fifo/pages/customer/Menu/menu_detail/menu_detail.dart';
...
class MenuAllView extends StatelessWidget {
  final String categoryName; // Menerima nama kategori dari halaman sebelumnya

  const MenuAllView({super.key, required this.categoryName});
                    ...
                    : GridView.builder(
                        ...
                        gridDelegate:
                            const SliverGridDelegateWithFixedCrossAxisCount(
                              ...
                              childAspectRatio:
                                  0.8, // Rasio lebar:tinggi card (sesuaikan jika perlu)
                              crossAxisSpacing: 16,
                              mainAxisSpacing: 16,
                            ),
