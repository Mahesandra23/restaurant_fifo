...
class MenuDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Kita tidak butuh repository di sini karena datanya sudah dilempar dari depan
    return MvvmBuilder<MenuDetailViewModel>(
      ...
      view: (context) {
        ...
        return Scaffold(
          ...
          // --- BAGIAN KONTEN (GAMBAR & DETAIL) ---
          body: CustomScrollView(
            slivers: [
              // Gambar Header yang Cantik
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: menu.imageUrl.isNotEmpty
                      ...
                      : Container(
                          ...
                          child: const Icon(Icons.fastfood, size: 80, color: AppRestaurantColors.secondary),
                        ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              menu.name,
                              style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppRestaurantColors.primary),
                            ),
                          ),
                      ...
                      const Text(
                        'Deskripsi Menu',
                        style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppRestaurantColors.primary),
                      ),
                      ...
                      const Text(
                        ...
                        style: TextStyle(color: AppRestaurantColors.secondary, height: 1.5),
                      ),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Misal: Jangan pakai bawang, pedas sedang...',
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        IconButton(
                          icon: const Icon(Icons.remove, color: AppRestaurantColors.primary),
                          onPressed: vm.decrement,
                        ),
                        Text(
                          '${vm.quantity}',
                          style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppRestaurantColors.primary),
                        ),
                        IconButton(
                          icon: const Icon(Icons.add, color: AppRestaurantColors.primary),
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.pop(context); // Kembali ke halaman sebelumnya setelah add to cart
                        },
                        child: Text(
                          'Tambah • Rp ${vm.totalPrice}',
                          style: const TextStyle(color: AppRestaurantColors.accent, fontWeight: FontWeight.bold, fontSize: 16),
                        ),
                      ),
                    ),
                  ),
