      ...
      child: Row(
        children: [
          ...
          IconButton(
            ...
            onPressed: () => _showEditProfileSheet(context, vm, session, userId, name, email, phone),
          ),
        ],
      ),
    );
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          bool successProfile = await vm.updateProfile(userId, newName, newPhone);
                          ...
                          if (newEmail.isNotEmpty || newPassword.isNotEmpty) {
                            if (currentPassword.isEmpty) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Please enter your current password to verify the security changes.'),
                          ...
                          if (successProfile && securityError == null) {
                            ...
                            if (ctx.mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text('Profile has been updated successfully! Please check your email if you changed it.'),
                            ...
                            if (ctx.mounted) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(securityError ?? 'Failed to update profile.'),
                                  backgroundColor: Colors.redAccent,
                                ),
                              );
                            }
