    ...
    return MvvmBuilder<IngredientsViewModel>(
      ...
      view: (context) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            title: const Text('Master Bahan', style: TextStyle(fontWeight: FontWeight.bold, color: AppRestaurantColors.accent)),
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              ListTile(
                                ...
                                title: Text(item.name, style: const TextStyle(fontWeight: FontWeight.w500, color: AppRestaurantColors.primary)),
                                subtitle: Text(item.id, style: const TextStyle(fontSize: 12, color: AppRestaurantColors.secondary)),
                                trailing: IconButton(
                                  icon: const Icon(Icons.remove_circle_outline, color: Colors.redAccent), // Semantik bahaya
          ...
          builder: (BuildContext context, StateSetter setState) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('Tambah Bahan Baru', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppRestaurantColors.primary)),
                      ...
                      onPressed: () {
                        if (name.trim().isNotEmpty) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Bahan berhasil ditambahkan!'), backgroundColor: Colors.green),
                          );
                        }
                      },
                      child: const Text('SIMPAN BAHAN', style: TextStyle(color: AppRestaurantColors.accent, fontWeight: FontWeight.bold)),
                    ),
                  ),
                  const SizedBox(height: 20),
                ],
